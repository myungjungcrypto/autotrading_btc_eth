...
export function loadConfig() {
  ...
  const cfg = {
    ...
    trading: {
      ...
      minClosePnlUsd: envNumber("MIN_CLOSE_PNL_USD", 0),
      minPositionHoldMs: envNumber("MIN_POSITION_HOLD_MS", 3000, { min: 0 }),
      tradeCooldownMs: envNumber("TRADE_COOLDOWN_MS", 5000, { min: 0 }),
